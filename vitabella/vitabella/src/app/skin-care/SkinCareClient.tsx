...
const SkinCareClient: React.FC = () => {
    const pageTitle = "Skin Care";
    
    return (
        <>
            <CategoryHero category="skin-care" />
            <BenefitsBar />
            <SectionHeader
              left={{
            ...
            />
            <ProductCategorySlider category="Skin Care" visibleCount={3} />
