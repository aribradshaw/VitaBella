...
const SexualWellnessClient: React.FC = () => {
    const pageTitle = "Sexual Wellness";
    
    return (
        <>
            <CategoryHero category="sexual-wellness" />
            <BenefitsBar />
            <SectionHeader
              left={{
            ...
            />
            <ProductCategorySlider category="Sexual Wellness" visibleCount={3} />
            <SectionHeader
              left={{
...
export default SexualWellnessClient;