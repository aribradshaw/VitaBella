...
const HairLossClient: React.FC = () => {
    const pageTitle = "Hair Loss";
    
    return (
        <>
            <CategoryHero category="hair-loss" />
            <BenefitsBar />
            <SectionHeader
              left={{
            ...
            />
            <ProductCategorySlider category="Hair Loss" visibleCount={3} />
            <SectionHeader
              left={{
