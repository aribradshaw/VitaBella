    ...
    <div className="hero-body" style={heroBodyStyle}>
      <div className="hero-container" style={heroContainerStyle}>
        ...
        <div className="testimonial">
          <img src="https://www.vitabella.com/wp-content/uploads/2025/03/fourreviewpeople.webp" alt="review people" width="142px" />
        ...
        <div className="navbar-inner">
          {categoryKeys.map((key, idx) => {
            ...
            return (
              ...
              >
                <img src={getNavIcon(key)} alt={`${navData.categoryName} Icon`} />
